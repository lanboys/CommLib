...
import com.bing.lan.comm.utils.picker.bean.CategoryBean;
...
public class PickerUtil {
    ...
    private void initOptionData(Activity activity) {
        ...
        //选项1
        options1Items.add(new ProvinceBean(0, "餐饮食品", "描述部分", "其他数据"));
        options1Items.add(new ProvinceBean(1, "休闲娱乐", "描述部分", "其他数据"));
    ...
    public interface PickerItemSelectListener {
        ...
        void onItemSelect(ArrayList<CategoryFirst> options1Items1,
