...
public class FileUtil {
    ...
    public static boolean copyFile(File srcFile, File destFile,
        ...
        try {
            ...
            LogUtil.getLogUtil(FileUtil.class).e("copyFile: ", e);
            return false;
        } finally {
            IOUtils.close(out);
            IOUtils.close(in);
    ...
    public static boolean isWriteable(String path) {
        try {
            ...
            LogUtil.getLogUtil(FileUtil.class).e("isWriteable: ", e);
            return false;
        }
    }
    ...
    public static void chmod(String path, String mode) {
        try {
            ...
            LogUtil.getLogUtil(FileUtil.class).e("chmod: ", e);
        }
    }
    ...
    public static boolean writeFile(InputStream is, String path,
        ...
        try {
            ...
            LogUtil.getLogUtil(FileUtil.class).e("writeFile: ", e);
        } finally {
            IOUtils.close(fos);
            IOUtils.close(is);
        }
    ...
    public static void writeMap(String filePath, Map<String, String> map,
        ...
        try {
            ...
            LogUtil.getLogUtil(FileUtil.class).e("writeMap: ", e);
        } finally {
            IOUtils.close(fis);
            IOUtils.close(fos);
        }
    ...
    public static Map<String, String> readMap(String filePath,
        ...
        try {
            ...
            LogUtil.getLogUtil(FileUtil.class).e("readMap: ", e);
        } finally {
            IOUtils.close(fis);
        }
        return map;
    ...
    public static boolean copy(String src, String des, boolean delete) {
        ...
        try {
            ...
            LogUtil.getLogUtil(FileUtil.class).e("copy: ", e);
            return false;
        } finally {
            IOUtils.close(in);
            IOUtils.close(out);
