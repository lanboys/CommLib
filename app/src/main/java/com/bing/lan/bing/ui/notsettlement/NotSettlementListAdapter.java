 ...
 */
public class NotSettlementListAdapter extends BaseListAdapter<NotSettlementInfoBean> {

    public NotSettlementListAdapter(Context context) {
        super(context);
    }
    ...
    class Holder extends BaseViewHolder {
        ...
        @Override
        public void fillData(NotSettlementInfoBean data, int position) {
